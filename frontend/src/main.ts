...
Object.assign(window, {
  ...
  togglePONotes: purchaseOrders.togglePONotes,
  ...
  showAccountTypesModal: reports.showAccountTypesModal,
  saveAccountType: reports.saveAccountType,
  toggleAccountType: reports.toggleAccountType,
  ...
  openCategoriesManager: settings.openCategoriesManager,
  switchCatalogType: settings.switchCatalogType,
  filterCatalogList: settings.filterCatalogList,
  showAddCatalogModal: settings.showAddCatalogModal,
  saveNewCatalogOption: settings.saveNewCatalogOption,
  showEditCatalogModal: settings.showEditCatalogModal,
  saveEditCatalogOption: settings.saveEditCatalogOption,
  deleteCatalogOption: settings.deleteCatalogOption,
